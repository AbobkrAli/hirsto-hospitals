...
import { X, Package, AlertTriangle, DollarSign, FlaskConical, Hash, TrendingDown } from 'lucide-react';
import type { MedicineData } from '../../services/medicineService';

interface LowStockMedicinesModalProps {
  isOpen: boolean;
  onClose: () => void;
  medicines: MedicineData[];
}

const LowStockMedicinesModal: React.FC<LowStockMedicinesModalProps> = ({
  isOpen,
  onClose,
  medicines
}) => {
                ...
                <div className="px-6 py-4 border-b border-gray-200/30 flex-shrink-0">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="text-xl font-semibold text-gray-900">Low Stock Medicines</h3>
                        <p className="text-sm text-gray-600">{medicines.length} medicines need attention</p>
                      </div>
                    </div>
                    <button
                      onClick={onClose}
                ...
                <div className="flex-1 overflow-y-auto px-6 py-4">
                  {medicines.length === 0 ? (
                    <div className="text-center py-12">
                      ...
                      <h3 className="text-lg font-medium text-gray-900 mb-2">All Medicines Well Stocked</h3>
                      <p className="text-gray-500">No medicines are running low on stock!</p>
                    </div>
                  ) : (
                        ...
                        >
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="flex items-center justify-between pt-2 border-t border-gray-200">
                              ...
                              <div className={`inline-flex px-3 py-1 rounded-full text-xs font-medium ${medicine.in_stock && medicine.quantity > 0
...
export default LowStockMedicinesModal;

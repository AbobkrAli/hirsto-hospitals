...
import { X, ShoppingCart, User, Package as PackageIcon, DollarSign, Clock } from 'lucide-react';
...
const TodaysOrdersModal: React.FC<TodaysOrdersModalProps> = ({
  isOpen,
  onClose,
  orders
}) => {
                ...
                <div className="px-6 py-4 border-b border-gray-200/30 flex-shrink-0">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="text-xl font-semibold text-gray-900">Today's Orders</h3>
                        <p className="text-sm text-gray-600">{orders.length} orders placed today</p>
                      </div>
                    </div>
                    <button
                      onClick={onClose}
                ...
                <div className="flex-1 overflow-y-auto px-6 py-4">
                  {orders.length === 0 ? (
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-500">No orders have been placed today yet!</p>
                    </div>
                  ) : (
